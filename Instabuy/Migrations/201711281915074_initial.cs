                ...
                c => new
                    {
                        ...
                        ConditionTypeId = c.Byte(nullable: false),
                        ConditionType = c.String(),
                        ListingTypeId = c.Byte(nullable: false),
                        ListingType = c.String(),
                        FeedbackScoreMin = c.Short(),
                        MinPrice = c.Int(),
                        MaxPrice = c.Int(),
                        ReturnsAcceptedOnly = c.Boolean(nullable: false),
                        UserId = c.String(),
                        LastCalled = c.Binary(),
                    })
                .PrimaryKey(t => t.Id);
